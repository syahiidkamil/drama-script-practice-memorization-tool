export const ROLES = {
  ...
  BECKY: {
    id: "BECKY",
    actor: "Saraska PutriImaniasari Lango",
    character: "Becky",
    description:
  ...
  BENS_FRIEND: {
    id: "BENS_FRIEND",
    actor: "Dear Kurniawan Adi Anggara",
